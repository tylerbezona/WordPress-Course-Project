...
/* harmony import */ var _modules_Leaflet__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Leaflet */ "./src/modules/Leaflet.js");
 // Our modules / classes
...
class LMap {
  ...
  new_map($el) {
    ...
    var map = L.map($el).setView([0, 0], 18); // original mapbox api version
  ...
  center_map(map) {
    var bounds = new L.LatLngBounds(); // loop through all markers and create bounds
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LMap);
